...
def eval(**args):
    ...
    for i in range(args['first']+2, args['last']-1):
        ...
        out = linear_transform(out, a, b, inverse=True)*args['data_scale'] # before inversing the linear transform, we unnormalize them back to the big range [0,data_scale]
...
if __name__ == "__main__":
    ...
    print(f"Command executed: python {' '.join(sys.argv)}")
